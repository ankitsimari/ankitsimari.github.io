  ...
  return (
    ...
    <div className='about section container-fluid  p-3  py-lg-5 grayBg' id="about">
        <div className="row justify-content-center">
          <h2 className='text-center fw-bold' id="user-detail-name">About</h2>
            <div className='col-md-11 ms-4 ms-lg-0 p-2 ps-lg-5' >
                ...
                {/* <button className="nav-link resume fw-bold text-black btn" target='_blank' href={PDF} id="resume-button-2">
                Resume
              </button> */}
        ...
        <li className="nav-item me-lg-5">
              <a className="nav-link resume fw-bold text-black" target='_blank' href={PDF} id="resume-button-2">
                Resume
              </a>
            </li>
    </div>
