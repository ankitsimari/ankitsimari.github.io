...
import PDF from "../Image/Ankit-Kumar-Resume.pdf";
...
export default function ({ handleChange, icon, mobile }) {
  ...
  return (
    <div>
      ...
      <nav className="navbar navbar-expand-lg  " id="nav-menu">
        ...
        >
          <ul className="navbar-nav mb-2 mb-lg-0 me-lg-5">
            <li className="nav-item">
              <a
                className="nav-link about fw-bold themeColor"
                href="#home"
            ...
            <li className="nav-item me-lg-5">
              <a
                className="nav-link resume fw-bold themeColor"
                target="_blank"
                onClick={() =>
                  window.open(
          ...
          {/* <ToggleBtn/> */}
          <button className="border-0 bg-transparent" onClick={handleChange}>
            {icon}
          </button>
