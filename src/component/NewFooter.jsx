...
export default function NewFooter() {
  return (
    <div> <footer class="footer themeBg">
    <div class="container">
        <div class="row">
            ...
            {/* <div class="col-sm-6 col-md-4 mt-4 col-lg-2 text-center text-sm-start">
              <div class="social">
                  ...
                  <span className=' fs-3 '>
                    <a className='text-decoration-none text-white' href="https://github.com/ankitsimari">  <AiFillGithub/></a>
                    <a className='text-decoration-none text-white' href="https://www.linkedin.com/in/ankit-kumar-747786235/">  <AiFillLinkedin/></a>
                    <a className='text-decoration-none text-white' href="https://www.instagram.com/ank_krs/"> <AiOutlineInstagram/></a>
                    <a className='text-decoration-none text-white' href="https://wa.me/+919576508805"> <BsWhatsapp/></a>
    ...
    <div class="text-center bg-dark text-white mt-4 p-1">
        <p class="mb-0 fw-bold">2023 © Ankit Kumar, All Rights Reserved</p>
    </div>
  </footer></div>
  )
}
